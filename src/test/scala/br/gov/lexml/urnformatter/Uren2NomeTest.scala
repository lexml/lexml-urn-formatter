...
class Uren2NomeTest extends TestCase {
  ...
  def testLabel_art1() {
    assertEquals("art. 1º", Urn2Nome.format("art1"))

    assertEquals("art. 1º-B", Urn2Nome.format("art1-2"))

    assertEquals("caput do art. 1º", Urn2Nome.format("art1_cpt"))

    assertEquals("caput do art. 1º do título II", Urn2Nome.format("tit2_art1_cpt"))

    assertEquals("título II", Urn2Nome.format("tit2"))

    assertEquals("título II-A", Urn2Nome.format("tit2-1"))

    assertEquals("caput do art. 1º do título II-A", Urn2Nome.format("tit2-1_art1_cpt"))
    ...
    assertEquals("caput do art. 1º", Urn2Nome.format("art1_cpt_alt1_art223-1"))
  }
  ...
  def testAgrupadores() {
    ...
    assertEquals("art. 1º do componente principal da raiz", Urn2Nome.format("lex_cpp_art1"))
    assertEquals("art. 1º do anexo a do componente principal da raiz", Urn2Nome.format("lex_cpp_anx1_art1"))
    assertEquals("art. 2º do anexo a do componente principal da raiz", Urn2Nome.format("lex_cpp_anx1_art2"))
  }
