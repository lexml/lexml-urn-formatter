...
class Urn2NomeCompactoTest extends TestCase {
  ...
  def testLabel_anx1_art25_27_anx1_art30() {
    assertEquals("arts. 25 a 27 e 30 do Anexo I", Urn2NomeCompacto.format(List("anx1_art25", "anx1_art26", "anx1_art27", "anx1_art30")))
  }
